...
if ($c_msg != "") {
 $db->query('INSERT INTO area_chat (area_name, lga_name, user_id, user_name, admin_msg, user_img, time) VALUES (:name_area, :name_lga, :id_user, :name_user, :message, :image, NOW())');
    $my_id = $_SESSION['admin_data']['id'];
    $full_name = $_SESSION['admin_data']['fullname'];
