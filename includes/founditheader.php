...
?>
  ...
  <meta itemprop="image" content="" />
        ...
        <!-- Custom CSS -->
        <link rel="stylesheet" type="text/css" href="changecss/foundit.css">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="reportFounditem.php">Found An Item?</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="reportLostitem.php">Lost An Item?</a>
          </li>
